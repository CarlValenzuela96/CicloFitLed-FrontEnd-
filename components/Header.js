...
const AddSesion = ({ isWhite, style, navigation }) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Pro')}>
    <Icon
      size={25}
...
const AddEstacion = ({ isWhite, style, navigation }) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Pro')}>
    <Icon
      size={25}
      name="add-circle-outline"
...
const AddUsuario = ({ isWhite, style, navigation }) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => navigation.navigate('Pro')}>
    <Icon
      size={25}
      name="add"
...
class Header extends React.Component {
  ...
  renderRight = () => {
    ...
    switch (routeName) {
      case 'Sesiones':
        return ([
          <AddSesion key='add-sesion' navigation={navigation} isWhite={white}></AddSesion>
        ]);
      case 'Estaciones':
        return ([
      ...
      case 'Ejercicios':
        return ([
          <AddEjercicio key='add-sesion' navigation={navigation} isWhite={white}></AddEjercicio>
        ]);
      case 'Usuarios':
        return ([
